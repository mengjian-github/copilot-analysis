...
const s = require(93136);
class ExtensionTextDocumentManager extends s.TextDocumentManager {
  constructor(e) {
    super();
    this.onDidFocusTextDocument = i.window.onDidChangeActiveTextEditor;
    this.onDidChangeTextDocument = i.workspace.onDidChangeTextDocument;
    this.onDidChangeCursor = i.window.onDidChangeTextEditorSelection;
  ...
  async getRelativePath(e) {
    ...
    if (t) {
      ...
      return s.getRelativePath(this.getWorkspaceFolders(), t.fileName) ?? r.basename(t.fileName);
    }
  }
  findNotebook(e) {
    const t = e;
