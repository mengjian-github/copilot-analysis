(() => {
  var __webpack_modules__ = {
    ...
    6976: (e, t, n) => {
      ...
      t.arrayDiff = void 0;
      var i = new ((r = n(5913)) && r.__esModule ? r : {
        default: r
      }).default();
      t.arrayDiff = i;
    ...
    4276: (e, t, n) => {
      ...
      function l(e, t, n, r, i) {
        ...
        if ("[object Array]" === a.call(e)) {
          for (t.push(e), c = new Array(e.length), n.push(c), o = 0; o < e.length; o += 1) c[o] = l(e[o], t, n, r, i);
          t.pop();
          n.pop();
          return c;
        }
        ...
        if ("object" === s(e) && null !== e) {
          ...
          for (p.sort(), o = 0; o < p.length; o += 1) c[u = p[o]] = l(e[u], t, n, r, u);
          t.pop(), n.pop();
        } else c = e;
        return c;
      }
      ...
      c.equals = function (e, t) {
        return i.default.prototype.equals.call(c, e.replace(/,([\r\n])/g, "$1"), t.replace(/,([\r\n])/g, "$1"));
      };
    },
    8187: (e, t, n) => {
      "use strict";
    ...
    5533: (e, t, n) => {
      ...
      t.fromTreeWithValuedLines = t.fromTreeWithFocussedLines = t.DEFAULT_TREE_TRAVERSAL_CONFIG = void 0;
      const r = n(2180);
      const i = n(4288);
      function o(e) {
      ...
      t.fromTreeWithFocussedLines = function (e, n = t.DEFAULT_TREE_TRAVERSAL_CONFIG) {
    ...
    4876: (e, t) => {
      ...
      t.duplicateTree = t.cutTreeAfterLine = t.isTop = t.isVirtual = t.isLine = t.isBlank = t.topNode = t.blankNode = t.lineNode = t.virtualNode = void 0;
    ...
    3059: (e, t, n) => {
      ...
      t.lastLineOf = t.firstLineOf = t.encodeTree = t.describeTree = t.deparseAndCutTree = t.deparseTree = t.deparseLine = void 0;
      const r = n(4876);
      const i = n(8617);
      function o(e) {
    ...
    2417: (e, t) => {
      ...
      t.getPathMarker = t.getLanguageMarker = t.commentBlockAsSingles = t.comment = t.hasLanguageMarker = t.languageCommentMarkers = void 0;
      ...
      t.getLanguageMarker = function (e) {
        ...
        return -1 !== n.indexOf(t) || i(e) ? "" : t in r ? r[t] : o(`Language: ${t}`, t);
      };
    ...
    5563: function (e, t, n) {
      ...
      t.createWorker = t.SnippetSemantics = t.SnippetProvider = t.NeighboringTabsOption = t.NeighboringSnippetType = t.getCursorContext = t.languageCommentMarkers = t.commentBlockAsSingles = t.comment = t.FileSystem = void 0;
      const o = n(1017);
      const s = n(1267);
      i(n(3346), t);
      var a = n(2271);
    ...
    9610: (e, t, n) => {
      ...
      t.isEmptyBlockStart = async function (e, t, n) {
        return !!r.isSupportedLanguageId(e) && p(e).isEmptyBlockStart(t, n);
      };
      t.isBlockBodyFinished = async function (e, t, n, i) {
        if (r.isSupportedLanguageId(e)) return p(e).isBlockBodyFinished(t, n, i);
      };
      t.getNodeStart = async function (e, t, n) {
        if (r.isSupportedLanguageId(e)) return p(e).getNodeStart(t, n);
      };
    },
    8312: (e, t, n) => {
      "use strict";
      ...
      t.getPrompt = async function (e, n, s = {}, g = [], _ = [], E) {
        ...
        if (T.languageMarker !== h.NoMarker) {
          const e = x(r.getLanguageMarker(n));
          F = B.append(e, p.PromptElementKind.LanguageMarker, O);
        }
        if (T.pathMarker !== f.NoMarker) {
          const e = x(r.getPathMarker(n));
          if (e.length > 0) {
            j = B.append(e, p.PromptElementKind.PathMarker, R);
          }
        }
        if (T.localImportContext !== y.NoContext) for (const e of await i.extractLocalImportContext(n, T.fs)) B.append(x(e), p.PromptElementKind.ImportedFile, M);
        ...
        if (0 === T.suffixPercent || q.length <= T.fimSuffixLengthThreshold) return B.fulfill(T.maxPromptLength);
        {
          ...
          const r = T.maxPromptLength - t.TOKENS_RESERVED_FOR_SUFFIX_ENCODING;
          ...
          if (T.suffixMatchCriteria === v.Equal) u.tokens.length === d.tokens.length && u.tokens.every((e, t) => e === d.tokens[t]) && (I = !0);else if (T.suffixMatchCriteria === v.Levenshtein && u.tokens.length > 0 && T.suffixMatchThreshold > 0) {
            const e = (0, l.findEditDistanceScore)(u.tokens.slice(0, t.MAX_EDIT_DISTANCE_LENGTH), d.tokens.slice(0, t.MAX_EDIT_DISTANCE_LENGTH))?.score;
            100 * e < T.suffixMatchThreshold * Math.min(t.MAX_EDIT_DISTANCE_LENGTH, u.tokens.length) && (I = !0);
          }
    ...
    6845: (e, t, n) => {
      ...
      }(l = t.CursorSnippetsPickingStrategy || (t.CursorSnippetsPickingStrategy = {}));
      const u = new class {
        constructor(e) {
          this.keys = [];
          this.cache = {};
    ...
    9404: (e, t, n) => {
      ...
      t.computeScore = t.FunctionJaccardMatcher = t.IndentationBasedJaccardMatcher = t.FixedWindowSizeJaccardMatcher = void 0;
      const r = n(648);
      const i = n(1467);
      const o = n(5380);
    ...
    9125: (e, t, n) => {
      ...
      t.getNeighborSnippets = t.neighborOptionToSelection = t.NeighboringSnippetType = t.NeighboringTabsOption = void 0;
      const r = n(9491);
      const i = n(6845);
      const o = n(9404);
      var s;
      var a;
      (a = t.NeighboringTabsOption || (t.NeighboringTabsOption = {})).None = "none";
      ...
      t.getNeighborSnippets = async function (e, n, a, c, l, u, p, d, h, f, m) {
        const g = {
    ...
    1467: (e, t, n) => {
      ...
      t.splitIntoWords = t.FunctionalMatcher = t.WindowedMatcher = t.SortOptions = void 0;
      const r = n(8306);
      const i = n(8312);
      const o = n(4830);
      var s;
      ...
      class l {
        ...
        retrieveAllSnippets(e, t = s.Descending) {
          ...
          const o = c.get(i) ?? [];
          const a = 0 == o.length;
          const l = a ? r.map(this.tokenizer.tokenize, this.tokenizer) : [];
          for (const [e, [t, i]] of this.getWindowsDelineations(r).entries()) {
            if (a) {
              const e = new Set();
    ...
    4830: (e, t, n) => {
      ...
      t.processSnippetsForWishlist = t.selectSnippets = t.normalizeSnippetScore = t.announceSnippet = t.SnippetSemantics = t.SnippetProvider = void 0;
      const r = n(2417);
      var i;
      var o;
      (o = t.SnippetProvider || (t.SnippetProvider = {})).NeighboringTabs = "neighboring-tabs";
    ...
    5380: (e, t, n) => {
      ...
      t.getIndentationWindowsDelineations = t.getBasicWindowDelineations = void 0;
      const r = n(8617);
      const i = n(3469);
    ...
    4087: (module, __unused_webpack_exports, __nested_webpack_require_105435__) => {
          ...
          static init(moduleOptions) {
            return initPromise || (Module = Object.assign({}, Module, moduleOptions), initPromise = new Promise(resolveInitPromise => {
              ...
              if (ENVIRONMENT_IS_NODE) {
                ...
                var nodePath = __nested_webpack_require_105435__(1017);
  ...
  function __nested_webpack_require_178258__(e) {
    ...
    __webpack_modules__[e].call(n.exports, n, n.exports, __nested_webpack_require_178258__);
    return n.exports;
  }
