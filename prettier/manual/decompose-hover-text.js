  ...
  exports.ExtensionSymbolDefinitionProvider = class {
    async getSymbolDefinition(e) {
      const t = {
        ...
        [n, o] = await this.getHoverTextAndDecompose(t);
      return "" === n ? [] : [{
        snippet: n,
        score: 1,
        startLine: t.line,
    ...
    async getHoverTextAndDecompose(e) {
      ...
      return t[0] && t[0].contents[0] instanceof i.MarkdownString ? s(t[0].contents[0].value) : ["", r.SnippetSemantics.Snippet];
    }
  }, exports.decomposeHoverText = s;