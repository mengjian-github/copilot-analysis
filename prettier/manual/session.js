Object.defineProperty(exports, "__esModule", {
  ...
  var a;
  !function (e) {
    e.GitHub = "github", e.GitHubEnterprise = "github-enterprise";
  ...
  exports.onDidChangeSessionsHandler = async function (e, n) {
    ...
    if (o.id === a) {
      ...
      (await r.authentication.getSession(a, l)) ? (e.forceNormal(), await n.get(i.CopilotTokenManager).getCopilotToken(n, !0)) : (n.get(i.CopilotTokenManager).resetCopilotToken(n), e.setWarning(exports.SESSION_LOGIN_MESSAGE));
    }
  }, exports.getSession = async function () {
    let e = await d(!1);
    if (!e && !u) {
      if (u = !0, "Sign in to GitHub" !== (await r.window.showInformationMessage("Sign in to use GitHub Copilot.", "Sign in to GitHub"))) throw new Error("GitHubLoginFailed");
      e = await d(!0);
    }
    return e;
  };