Object.defineProperty(exports, "__esModule", {
  ...
  exports.installCopilotChatExtensionIfNeeded = async function (e) {
    ...
    const n = e.get(o.VsCodeExtensionContext),
      a = n.extensionMode === r.ExtensionMode.Production,
      c = "GitHub.copilot-nightly" === n.extension.id;
    if (!a || c) try {
      t.logIt(e, i.LogLevel.INFO, "Installing CopilotChat"), await r.commands.executeCommand("workbench.extensions.installExtension", s, {
        donotSync: !0,
